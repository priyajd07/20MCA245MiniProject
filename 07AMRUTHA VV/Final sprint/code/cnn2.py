...
def read_dataset():
    ...
    label_list = []
    i=0
    my_list = os.listdir(r'static\\retinal_images')
    for pa in my_list:

        print(pa,"==================",i)
        for root, dirs, files in os.walk(r'static\\retinal_images\\' + pa):

         for f in files:
            file_path = os.path.join(r'static\\retinal_images\\'+pa, f)
            # print(file_path)
