...
public class doctospeech extends Activity {
    TextView e1;
    Button b1,b2;
    ...
    String dob, obective, house;
    String gender = "";
    String url, ip, lid,title,url1,tarea,titles;
    String PathHolder="",result;
    byte[] filedt=null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_doctospeech);
        ...
        url = "http://"+sh.getString("ip","")+":5000/doctospeech";
...
//                params.put("tribearea",tarea);


                params.put("lid",sh.getString("id","1"));
