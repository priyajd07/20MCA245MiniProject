...
public class sendcomplaints extends AppCompatActivity implements View.OnClickListener {
    EditText ed1;
    Button bt1;
    ...
    public void onClick(View v) {
        ...
        if(comp.length()==0){
            ed1.setError("Complaint cannot be empty...");
        }
        else{
            SharedPreferences sh = PreferenceManager.getDefaultSharedPreferences(getApplicationContext());
            String ip = sh.getString("ip", "");
            String url = "http://" + ip + ":5000/and_driver_send_complaint";
