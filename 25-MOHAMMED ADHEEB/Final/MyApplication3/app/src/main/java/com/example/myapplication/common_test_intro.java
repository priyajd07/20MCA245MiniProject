...
public class common_test_intro extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    Spinner s1,s2;
    ...
    ArrayList<String>company,comid,post,postid,aid;
    String ur,url;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_common_test_intro);
...
//
        url="http://"+sh.getString("ip","")+":5000/addquesnew";
//        //	new Insert().execute();
        try
        {
...
//
        String url1 = "http://" + sh.getString("ip", "") + ":5000/select_companyy1";

        RequestQueue queue = Volley.newRequestQueue(common_test_intro.this);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url1, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    aid = new ArrayList<>(ar.length());

                    for (int i = 0; i < ar.length(); i++) {
                        JSONObject jo = ar.getJSONObject(i);
                        company.add(jo.getString("job_name")+" "+jo.getString("company_name"));
                        comid.add(jo.getString("job_id"));
                        aid.add(jo.getString("apply_id"));


                    }

                    ArrayAdapter<String> ad = new ArrayAdapter<String>(common_test_intro.this, android.R.layout.simple_spinner_item, company);
                    s1.setAdapter(ad);
                    s1.setOnItemSelectedListener(common_test_intro.this);
...
//
//        RequestQueue queue1 = Volley.newRequestQueue(common_test_intro.this);
//
...
//                    }
//
//                    ArrayAdapter<String> ad = new ArrayAdapter<String>(common_test_intro.this, android.R.layout.simple_spinner_item,post);
//                    s2.setAdapter(ad);
//                    s2.setOnItemSelectedListener(common_test_intro.this);
//
//                    // l1.setAdapter(new custom2(Monitoring_signal.this,notification,date));
//
//                } catch (JSONException e) {
...
//        queue1.add(stringRequest1);
    ...
    public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
        if (adapterView==s1) {
            ...
            ed.putString("pid", compid);
            ed.putString("aid", aid.get(i));
...
//            }
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST, url,new Response.Listener<String>() {
                ...
                protected Map<String, String> getParams() {
                    ...
                    params.put("sid", sh.getString("pid",""));
