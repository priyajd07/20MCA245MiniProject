...
public class partner_view_logs extends AppCompatActivity {
    ListView lv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_partner_view_logs);
        lv=(ListView)findViewById(R.id.list);

        SharedPreferences sh= PreferenceManager.getDefaultSharedPreferences(getApplicationContext());
        String hu = sh.getString("ip", "");
        String url = "http://" + hu + ":5000/and_partner_view_driver_logs";
                        ...
                        try {
                            ...
                            if (jsonObj.getString("status").equalsIgnoreCase("ok")) {
                                ...
                                for(int i=0;i<js.length();i++)
                                {
                                    ...
                                    angle[i]=u.getString("angle");
                                }
                                lv.setAdapter(new custom_driverlogs(getApplicationContext(),date, time, speed, angle));
                            }
