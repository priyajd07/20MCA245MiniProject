...
public class view_msg_frm_partner extends AppCompatActivity implements View.OnClickListener {
    ListView lv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_msg_frm_partner);
        lv=(ListView)findViewById(R.id.list);


        SharedPreferences sh= PreferenceManager.getDefaultSharedPreferences(getApplicationContext());
        String hu = sh.getString("ip", "");
        String url = "http://" + hu + ":5000/and_driver_view_msg";
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST, url,
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("p_lid", sh.getString("sel_pid", ""));
